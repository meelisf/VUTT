...
# Jagatud indeksite kirjutuslukud. Üks allikas on state.py, et legacy- ja
# domeenimoodulite kirjutusteed ei kasutaks erinevaid lukke.
from .state import _index_lock, _works_lock, _aliases_lock, _work_collections_lock
