...
update_work_facts = state.update_work_facts
remove_work_facts = state.remove_work_facts
...
__all__ = ['PROSOPOGRAPHY_DIR', 'PROSOPOGRAPHY_IMAGES_DIR', 'PROSOPOGRAPHY_INDEX_FILE', 'PERSON_TO_WORKS_FILE', 'PERSON_ALIASES_FILE', 'WORK_COLLECTIONS_INDEX_FILE', 'BASE_DIR', 'save_with_git', 'delete_file_from_git', 'atomic_write_json', '_glob', 'build_works_creators_index', 'update_work_facts', 'remove_work_facts', 'get_work_relations', '_resolve_origin_group', '_get_parent_place', '_get_place_labels', '_get_place_coordinates', '_enrich_origin_from_places', '_load_origin_groups', '_index_lock', '_works_lock', '_aliases_lock', '_work_collections_lock', '_safe_nanoid', '_id_to_path', '_strip_markup', '_make_snippets', 'get_person', 'create_person', '_new_person_skeleton', '_make_date_obj', '_propagate_name_to_works', '_apply_card_update', 'update_person', 'add_identifier', '_person_image_path', 'upload_person_image', 'get_person_image_path', 'delete_person_image', 'apply_enrichment', 'restore_person', 'IdentifierConflict', '_check_identifiers_free', '_find_by_external_id', 'ensure_prosopo_for_entity', 'ensure_prosopo_stubs', 'bulk_update_occupation', 'SERVER_FIELDS', 'strip_server_fields', 'create_person_checked', 'set_enrichment_scheduler', '_has_similar_name', 'list_persons', '_filter_index_entries', '_entry_matches_year_range', 'get_person_map_markers', 'get_person_facets', '_load_person_aliases', '_index_entry_from_person', '_extract_occupation_entries', '_entry_occupations', '_entry_tags', '_normalize_tag_query', '_tag_match_keys', 'get_person_with_works', '_build_work_to_persons', 'get_persons_for_work', '_structured_relation_ids', 'get_person_relation_network_ids', 'get_relation_type_suggestions', 'update_page_person_mentions', '_load_index', '_load_person_to_works', '_load_work_collections', 'update_work_collections', '_collection_descendants', '_persons_in_collection', '_person_collections', '_update_index_entry', '_update_aliases_entry', 'update_person_to_works', 'rebuild_indices', '_remove_aliases_entry', 'merge_person', 'delete_person', 'compute_person_diff']
