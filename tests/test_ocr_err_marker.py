...
def test_poll_kirje_kannab_importable_lippu():
    ...
    assert page_status.is_importable({"has_ocr": True}) is True
    assert page_status.is_importable(
...
def test_ilma_ocrita_ja_ilma_veata_ei_ole_importable():
    ...
    assert page_status.is_importable({"has_ocr": False}) is False
    assert page_status.is_importable({"has_ocr": False, "ocr_error": ""}) is False
